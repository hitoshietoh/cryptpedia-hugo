...
# Cosmos
## 概要
Cosmosが目指すのは多くのチェーンを接続し、ブロックチェーンのインターネット。  
IBCという規格で通信が行われている。  
主要トークンはATOM
...
### Sentinel
Global Web of Decentralized Virtual Private Networks built on a P2P bandwidth sharing marketplace. Build secure $dVPN apps on Sentinel.
...
### BitSong
enriching the artist and fan relationship.
...
### Regen
Platform for a Thriving Planet 🌏 nothing less than planetary regeneration. 
- [official](https://t.co/7NelV3G0hp)
- [Twitter](https://twitter.com/regen_network)

### KiChain
Ki is bridging CeFi & DeFi.
...
### Bitcanna
Swap $BCNA decentralized on Osmosis
